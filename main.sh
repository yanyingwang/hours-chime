...
#DISPLAY=:0 notify-send -a "整点提醒" -u normal -t 3 -i "${HOME}/hours-chime/fav.png" "整点提醒：现在时刻${HOUR}点整。"
# pactl set-sink-volume @DEFAULT_SINK@ -10%
# pactl set-sink-volume @DEFAULT_SINK@ +10%

# play -v 8 "${HOME}/hours-chime/audio/westminster/first-quarter.mp3"
# play "${HOME}/hours-chime/audio/chunch-bell/church-bellAa.mp3"
# play -v 0.8 "${HOME}/hours-chime/audio/chunch-bell/church-bellAaa.mp3"
...
play -v 0.6 "${HOME}/hours-chime/audio/电台DJ/${HOUR}.wav"
